        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseRecords_AspNetUsers_CreatedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExpenseRecords_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PetTasks_AspNetUsers_CompletedById",
                        column: x => x.CompletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PetTasks_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PetTasks_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecords_CreatedById",
                table: "ExpenseRecords",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecords_PetId",
                table: "ExpenseRecords",
                column: "PetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetTasks_CompletedById",
                table: "PetTasks",
                column: "CompletedById");

            migrationBuilder.CreateIndex(
                name: "IX_PetTasks_CreatedById",
                table: "PetTasks",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_PetTasks_PetId",
                table: "PetTasks",
                column: "PetId");
        }
